(function ($) {
	...
	class Silence {
		...
		buildCustomElements() {
			...
			$("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="https://blog.csdn.net/Tonight_Fantasy">友链</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="">关于</a><i></i></li>');
			//添加标签icon
